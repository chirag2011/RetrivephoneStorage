...
public class PdfFileActivity extends AppCompatActivity implements onPadfSelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.xRecyclerviewPdf);
        displayPdf();
    ...
    public void onPdfSelected(File file) {
        startActivity(new Intent(PdfFileActivity.this, DocumentShowActivity.class)
