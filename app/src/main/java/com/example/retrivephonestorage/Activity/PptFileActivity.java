...
public class PptFileActivity extends AppCompatActivity implements onPadfSelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.xRecyclerviewPpt);
        displayPdf();
    }
    ...
    public ArrayList<File> findPdf(File file){
        ...
        for (File singleFile: files){
            if (singleFile.isDirectory() && !singleFile.isHidden()){
                ...
                if (singleFile.getName().endsWith(".ppt") || singleFile.getName().endsWith(".pptx")){
    ...
    public void onPdfSelected(File file) {
        startActivity(new Intent(PptFileActivity.this, DocumentShowActivity.class)
